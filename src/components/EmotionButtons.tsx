...
const options: { id: Emotion; emoji: string; label: string; gradient: string }[] = [
  { id: "loved", emoji: "⭐", label: "Loved it", gradient: "bg-gradient-warm text-primary-foreground" },
  { id: "okay", emoji: "😐", label: "It was okay", gradient: "bg-gradient-blush text-chocolate" },
  { id: "improve", emoji: "😞", label: "Needs improvement", gradient: "bg-gradient-cocoa text-cream" },
];
