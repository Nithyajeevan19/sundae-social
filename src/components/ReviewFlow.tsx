  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <h3 className="mt-3 font-display text-2xl text-chocolate">
      ...
      <div className="mt-5 space-y-3">
        <AnimatedButton
          variant="primary"
          fullWidth
          onClick={() => { window.open(INSTAGRAM_URL, "_blank"); onDone(); }}
        >
        ...
        <AnimatedButton
          variant="cream"
          fullWidth
          onClick={() => { window.open(GOOGLE_REVIEW_URL, "_blank"); onDone(); }}
        >
